...
class PhonePe:
    def __init__(self, merchant_id: str, phone_pe_salt: str, phone_pe_host: str, redirect_url: str, callback_url: str,
    ...
    def create_order(self, order_id, amount, user):
        ...
        payload = {
            ...
            "callbackUrl": self.callback_url,  # Change 'webhookUrl' to 'callbackUrl'
            "paymentInstrument": {
                "type": "PAY_PAGE"
            }
        }
